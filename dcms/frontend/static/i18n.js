...
(function () {
  ...
  const TRANSLATIONS = {
    ar: {
      ...
      'netctrl.tab.console': 'كونسول الأجهزة',
      ...
      'console.quick_connect': 'اتصال مباشر بالجهاز',
      'console.quick_connect_hint': 'أدخل عنوان IP وبيانات SSH للدخول إلى كونسول الجهاز وتنفيذ الأوامر',
      'console.test_connection': 'اختبار الاتصال',
      'console.open_console': 'فتح الكونسول',
      'console.open_live': 'كونسول مباشر',
      'console.command_library': 'مكتبة الأوامر',
      'console.run': 'تنفيذ',
      'console.clear': 'مسح',
      'console.port': 'المنفذ',
      'console.mode_exec': 'تنفيذ',
      'console.mode_config': 'تطبيق إعداد',
      'console.target_device': 'الجهاز المستهدف',
      'console.apply_config': 'تطبيق على الجهاز',
      'console.connected': 'تم الاتصال بـ {host}',
      'console.failed': 'فشل الاتصال أو التنفيذ',
      'console.ready': 'الكونسول جاهز — اختر أمراً من المكتبة أو اكتب أمراً مخصصاً',
      'console.switch_hint': 'افتح كونسول SSH مباشر للجهاز لتنفيذ أوامر show وتطبيق الإعدادات',
      'console.registered_devices': 'أجهزة مسجّلة',
      'console.apply_ok': 'تم تطبيق الإعداد بنجاح',
      'console.apply_confirm': 'تطبيق هذا الإعداد على الجهاز؟ سيتم تنفيذ التغييرات مباشرة.',
      ...
      'common.close': 'إغلاق',
      'common.action': 'إجراء',
      'common.no_permission': 'لا تملك صلاحية لهذا الإجراء',
      'common.view': 'عرض',
      'common.name': 'الاسم',
      'common.ip': 'IP',
    ...
    en: {
      ...
      'netctrl.tab.console': 'Device Console',
      ...
      'console.quick_connect': 'Direct device connection',
      'console.quick_connect_hint': 'Enter IP and SSH credentials to open a live device console and run commands',
      'console.test_connection': 'Test connection',
      'console.open_console': 'Open console',
      'console.open_live': 'Live console',
      'console.command_library': 'Command library',
      'console.run': 'Run',
      'console.clear': 'Clear',
      'console.port': 'Port',
      'console.mode_exec': 'Execute',
      'console.mode_config': 'Apply config',
      'console.target_device': 'Target device',
      'console.apply_config': 'Apply to device',
      'console.connected': 'Connected to {host}',
      'console.failed': 'Connection or execution failed',
      'console.ready': 'Console ready — pick a library command or type a custom command',
      'console.switch_hint': 'Open a live SSH console to run show commands and push configuration',
      'console.registered_devices': 'Registered devices',
      'console.apply_ok': 'Configuration applied successfully',
      'console.apply_confirm': 'Apply this configuration to the device? Changes will be pushed immediately.',
      ...
      'common.no_permission': 'You do not have permission for this action',
      'common.view': 'View',
      'common.name': 'Name',
      'common.ip': 'IP',
