...
(function () {
  ...
  const TRANSLATIONS = {
    ar: {
      ...
      'netctrl.swtab.access': 'Access Ports',
      'netctrl.swtab.trunks': 'Trunks',
      'netctrl.swtab.config': 'الإعدادات',
      'netctrl.swtab.console': 'كونسول',
      'netctrl.swtab.ports_on_vlan': 'المنافذ على VLAN',
      'netctrl.backup_config': 'نسخة إعدادات',
      'netctrl.config_empty': 'لا توجد إعدادات محفوظة — اضغط نسخة إعدادات',
      'netctrl.console_hint': 'عارض الإعدادات — كما على كونسول الجهاز',
      'netctrl.no_access_ports': 'لا توجد منافذ Access',
      'netctrl.no_trunks': 'لا توجد منافذ Trunk',
      'netctrl.trunk_vlans': 'VLANs على Trunk',
      ...
      'capabilities.open_panel': 'فتح اللوحة الكاملة',
      'capabilities.close': 'إغلاق',
      'capabilities.devices_count': 'الأجهزة',
      'capabilities.switches_list': 'السويجات والأجهزة',
      'capabilities.manage_device': 'إدارة الجهاز',
      'capabilities.open_switch': 'فتح الإعدادات',
      'capabilities.no_cisco_juniper': 'لا توجد أجهزة Cisco/Juniper — أضف جهازاً من قائمة الأجهزة',
      'capabilities.no_datacenters': 'لا توجد مراكز بيانات',
      'capabilities.open_dc': 'فتح المركز',
      'capabilities.run_backup_all': 'نسخ احتياطي للكل',
      'capabilities.sync_all_snmp': 'مزامنة SNMP للشبكة',
      'capabilities.open_theme': 'استوديو المظهر',
    ...
    en: {
      ...
      'netctrl.swtab.access': 'Access Ports',
      'netctrl.swtab.trunks': 'Trunks',
      'netctrl.swtab.config': 'Configuration',
      'netctrl.swtab.console': 'Console',
      'netctrl.swtab.ports_on_vlan': 'Ports on VLAN',
      'netctrl.backup_config': 'Backup config',
      'netctrl.config_empty': 'No saved configuration — click Backup config',
      'netctrl.console_hint': 'Configuration viewer — device console style',
      'netctrl.no_access_ports': 'No access ports',
      'netctrl.no_trunks': 'No trunk ports',
      'netctrl.trunk_vlans': 'Trunk VLANs',
      ...
      'capabilities.open_panel': 'Open full panel',
      'capabilities.close': 'Close',
      'capabilities.devices_count': 'Devices',
      'capabilities.switches_list': 'Switches & devices',
      'capabilities.manage_device': 'Manage device',
      'capabilities.open_switch': 'Open settings',
      'capabilities.no_cisco_juniper': 'No Cisco/Juniper devices — add one from Devices',
      'capabilities.no_datacenters': 'No data centers',
      'capabilities.open_dc': 'Open center',
      'capabilities.run_backup_all': 'Backup all',
      'capabilities.sync_all_snmp': 'Sync transport SNMP',
      'capabilities.open_theme': 'Theme Studio',
